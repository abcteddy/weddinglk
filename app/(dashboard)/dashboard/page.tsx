        ...
        <div className="flex gap-3">
          {invitation && (
            <Link
              ...
              className="inline-flex items-center gap-2 px-4 py-2 bg-white/5 border border-white/15 text-sm text-parchment-300 rounded-sm hover:bg-white/10 hover:text-white transition-all"
            >
              📁 Database & Storage
            </Link>
          )}
